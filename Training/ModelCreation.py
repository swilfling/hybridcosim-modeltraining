...
def create_expanders(expansion, **kwargs):
    ...
    for expander_name in expansion:
        ...
        expander = type(**kwargs.pop('expander_parameters',None)) if expander_name == 'PolynomialExpansion' else type()
...
def create_model(training_params: TrainingParams, **kwargs):
    ...
    expanders = create_expanders(training_params.expansion, expander_parameters=kwargs.pop('expander_parameters',{}))
