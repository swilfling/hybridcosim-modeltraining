from ModelTraining.Data.DataImport.dataimport import CSVImport, ExcelImport, HDFImport, DataImport, TXTImport
import os
...
#%%
    filename = f"../Data/Data/Beyond/LEEDR/LEEDR_data_minute_temperature/processed-H01-Accounts-3-31-temperature-CLEAN"
    filename_head = f"../Data/Data/Beyond/LEEDR/LEEDR_data_minute_temperature/processed-H01-Accounts-3-31-temperature"



    data_import = TXTImport(freq='1min', use_octave_header=True, octave_header_file=filename_head,
